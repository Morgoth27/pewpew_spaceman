			...
			<>
                ...
                <div className="shopPanelHolder">
                    <div className="shipPanel">
                            ...
                            <div className="shipUpgrade">
                                ...
                                <div className="upgradeInfoSurround">
                                    <div className="upgradeInfo">
                                        ...
                                        <div className="upgradeBasicDesc">Details about the upgrade will go inside this box.</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="shopColumn shipColumn2">
                    ...
                    <div className="stationPanel">
                        ...
                        <div className="shopColumn stationColumn2">
